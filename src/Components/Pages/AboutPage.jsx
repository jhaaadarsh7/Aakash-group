...
import second from "../../assets/images/5.avif";
import sir from "../../assets/images/sir.jpeg";

import third from "../../assets/images/4.jpeg";
...
const heroImages = [
  ...
  },
  {
    ...
    subtitle:
      "Leading Nepal's digital transformation with cutting-edge technology and forward-thinking solutions across all business verticals.",
  },
  {
    src: third,
    ...
    subtitle:
      "We believe growth means more than business – we're shaping a better Nepal by creating jobs, inspiring young leaders, and building sustainably.",
  },
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-3xl p-8 lg:p-12 shadow-2xl border border-gray-100">
              <div className="space-y-8">
                <p className="text-lg lg:text-xl text-gray-700 leading-relaxed">
                  What began 150 years ago as a humble trading venture —
                  importing textiles and electronics into Nepal — has grown into
                  one of the nation's most trusted and diversified business
                  groups. Over the decades, Aakash Group has evolved with the
                  aspirations of the people, expanding into packaged food
                  manufacturing, hospitality, insurance, real estate, and
                  banking.
                </p>
                <p className="text-lg lg:text-xl text-gray-700 leading-relaxed">
                  Our journey reflects a deep-rooted commitment to progress —
                  ...
                  {[
                    {
                      year: "1870s",
                      title: "Foundation",
                      desc: "Started as textile & electronics importer",
                    },
                    {
                      year: "1950s",
                      title: "Diversification",
                      desc: "Diversified into multiple industries",
                    },
                    {
                      year: "2020s",
                      title: "Expansion",
                      desc: "Business growth and scaling",
                    },
                  ].map((milestone, index) => (
            ...
            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                <div className="relative inline-block mb-6">
                  <div className="relative p-1 bg-gradient-to-br from-slate-200 via-gray-300 to-slate-400 rounded-2xl shadow-xl">
                    <div className="relative bg-white p-2 rounded-xl">
                      <div className="w-52 h-60 lg:w-72 lg:h-80 rounded-xl overflow-hidden shadow-lg mx-auto lg:mx-0 bg-gradient-to-br from-gray-100 to-gray-200">
                        <img
                          src={MD}
      ...
      <section
        id="careers"
        ref={ctaRef}
        className="py-16 sm:py-20 lg:py-24 bg-gradient-to-r from-blue-700 to-blue-400 relative overflow-hidden"
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 text-center relative z-10">
          ...
          <p
            ref={ctaSubtitleRef}
            className="text-lg lg:text-xl text-blue-100 mb-12 max-w-4xl mx-auto leading-relaxed"
          >
            Be part of Nepal's most dynamic business group. We're always looking
            for talented individuals who share our vision of building a better
            tomorrow. Discover opportunities across our diverse portfolio of
